...
public class TC_ID_17_B  extends Launch{
...
@Test	(dependsOnMethods = { "TC_ID_17_02" })	
...
@Test (dependsOnMethods = { "TC_ID_17_03" })
...
@Test (dependsOnMethods = { "TC_ID_17_04" })
...
@Test (dependsOnMethods = { "TC_ID_17_05" })
...
@Test (dependsOnMethods = { "TC_ID_17_06" })
...
@Test (dependsOnMethods = { "TC_ID_17_07" })
...
@Test (dependsOnMethods = { "TC_ID_17_08" })
...
@Test  (dependsOnMethods = { "TC_ID_17_09" })

	public void TC_ID_17_10 () throws InterruptedException {
		
	TouchAction touchAction = new TouchAction(driver);

    touchAction.tap(PointOption.point(491, 1691)).perform();
...
@Test (dependsOnMethods = { "TC_ID_17_10" })
	

	public void TC_ID_17_11 () throws InterruptedException {
	
		WebElement CameraIcon = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.LinearLayout/android.widget.LinearLayout[3]/android.widget.Button[2]"));
		...
		WebElement ProfileImage = driver.findElement(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout/android.view.View/android.view.View/android.view.View/android.view.View/android.view.View/android.widget.ImageView"));
...
@Test  (dependsOnMethods = { "TC_ID_17_11" })
...
@Test	(dependsOnMethods = { "TC_ID_17_12" })
	public void TC_ID_17_13 () throws InterruptedException {
		WebElement  UseCurrentLocationField = driver.findElement(By.xpath("//android.view.View[@content-desc='Use current location']"));
		Assert.assertEquals(true, UseCurrentLocationField.isDisplayed());
		System.out.println("UseCurrentLocationField");
		Thread.sleep(5000);
		
		driver.findElement(By.xpath("//android.view.View[@content-desc='Use current location']")).click();
		Thread.sleep(5000);
		
	}

@Test  (dependsOnMethods = { "TC_ID_17_13" })
...
@Test  (dependsOnMethods = { "TC_ID_17_14" })
...
@Test  (dependsOnMethods = { "TC_ID_17_15" })
...
@Test (dependsOnMethods = { "TC_ID_17_16" })
...
@Test  (dependsOnMethods = { "TC_ID_17_17" })
...
@Test  (dependsOnMethods = { "TC_ID_17_18" })
...
@Test  (dependsOnMethods = { "TC_ID_17_19" })
